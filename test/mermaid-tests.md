...
1. [フローチャート（色設定あり）](#フローチャート色設定あり)
2. [シーケンス図（色設定あり）](#シーケンス図色設定あり)
3. [クラス図（色設定あり）](#クラス図色設定あり)
4. [状態遷移図（色設定あり）](#状態遷移図色設定あり)
...
- [ ] フローチャートの色が正しく表示される（3種類とも）
- [ ] シーケンス図の色付きボックス（rect）が表示される（2種類とも）
- [ ] クラス図の各クラスに色が付いている（style方式、classDef方式の両方）
...
- [ ] フローチャートの色が暗い色に変換されている（すべて）
- [ ] シーケンス図の色付きボックスが暗く表示される
- [ ] クラス図の色が適切に変換されている（style方式、classDef方式の両方）
- [ ] 状態遷移図がダークテーマカラーで表示される
- [ ] ガントチャートのdoneタスクのテキストが読める
- [ ] ガントチャートのactiveタスクが暗い青色になっている
- [ ] ガントチャートのcritタスクが暗い赤に白文字になっている
- [ ] すべてのテキストが背景とのコントラストが十分
- [ ] 明るい色が暗く、暗い色が明るく変換されている（色変換テスト）
- [ ] Gitグラフ、ER図、円グラフがダークテーマで表示される
